# START HERE — Playa Constraint Screening

Follow this top to bottom once and you'll an interactive statewide map, a report for every project boundary, and a ranked spreadsheet. The map comes out self-contained and the data is built right into the file. You just double-click it.
